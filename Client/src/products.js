                        ...
                        {products.map((product) => (
                            <tr key={product.id} className="border-b hover:bg-gray-100">
                                <td className="px-6 py-3">
                                    <input className="w-full px-2 py-1 border rounded-md text-gray-700 focus:outline-none focus:ring-2 focus:ring-teal-400" value={product.name} onChange={(e) => inputChange(product.id, "name", e.target.value)}/>
                                </td>
                                <td className="px-6 py-3">
                                    <textarea className="w-full px-2 py-1 border rounded-md text-gray-700 focus:outline-none focus:ring-2 focus:ring-teal-400" value={product.description} onChange={(e) => inputChange(product.id, "description", e.target.value)}/>
                                </td>
                                <td className="px-6 py-3">
                                ...
                                <td className="px-6 py-3">
                                    <input className="w-full px-2 py-1 border rounded-md text-gray-700 focus:outline-none focus:ring-2 focus:ring-teal-400" value={product.price} onChange={(e) => inputChange(product.id, "price", e.target.value)}/>
                                </td>
